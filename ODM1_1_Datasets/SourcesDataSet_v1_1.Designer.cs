...
SELECT SourceID, Organization, SourceDescription, SourceLink, ContactName, Phone, Email, Address, City, State, ZipCode, Citation, MetadataID FROM Sources WHERE (SourceID = @SourceID)";
        ...
        public virtual int Fill(DataSet1.SourcesDataTable dataTable) {
        ...
        public virtual DataSet1.SourcesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.SourcesDataTable dataTable = new DataSet1.SourcesDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.SourcesDataTable dataTable) {
